...
export class FavoriteFitnesses {
  ...
  user: User;
  @ApiProperty({example: mongoose.Schema.Types.Array, description:"Список тренувань"})
  @Prop({type: mongoose.Schema.Types.Array, default: []})
  diets: mongoose.Schema.Types.Array
}

export const FavoriteFitnessesSchema = SchemaFactory.createForClass(FavoriteFitnesses);